...
from models.fmnist_model import ClientNet, ServerNet
...
def run_experiment():
    data_dir = 'data'
    output_dir = "summary_pic/fmnist/"
    n_local = [1, 1, 1, 1]
    delay_factor = [0, 0, 0.06]
    batch_size = 256
    epochs = 2
    shuffle = True
    ...
    feature_num = 200  # the number of feature needed to be selected
    random = True  # select features randomly
    fixed = True  # select features dynamically or fixedly
    ...
    div1 = 4  # 1 * 28 * 4 112
    div2 = 12  # 1 * 28 * 8 224 1 * 28 * 16 448

    train_dataset = datasets.FashionMNIST(data_dir, train=True, download=True, transform=transform)
    test_dataset = datasets.FashionMNIST(data_dir, train=False, download=True, transform=transform)
    client1_train_dataset = datasets.FashionMNIST(data_dir, train=True, download=True, transform=transform)
    client1_test_dataset = datasets.FashionMNIST(data_dir, train=False, download=True, transform=transform)
    client2_train_dataset = datasets.FashionMNIST(data_dir, train=True, download=True, transform=transform)
    client2_test_dataset = datasets.FashionMNIST(data_dir, train=False,  download=True, transform=transform)
    client3_train_dataset = datasets.FashionMNIST(data_dir, train=True, download=True, transform=transform)
    client3_test_dataset = datasets.FashionMNIST(data_dir, train=False, download=True, transform=transform)
    ...
    client3_model = ClientNet(28 - div2).to(device)
